...
Use rm to run our version of the rm command. 
	-r Remove directories recursively
	-f Force removal without backing up to the dumpster
	-d Specify a dumpster directory
	-h Display this help and exit
 
Use dv to run our version of the dv (dive) command to retrieve a file from dumpster
	-d Specify a dumpster directory
	-h Display this help and exit

Use dump to run our version of the dump (clear dumpster) command
	 -d Specify a dumpster directory
	 -h Display this help and exit
